...
export class Backend implements backendInterface {
    ...
    async createOrUpdateProfile(arg0: string, arg1: number, arg2: number, arg3: number): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getRecommendations(arg0: string, arg1: string): Promise<Array<Dish>> {
        if (this.processError) {
            try {
                const result = await this.actor.getRecommendations(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getTasteVector(): Promise<TasteVector> {
        if (this.processError) {
            try {
                const result = await this.actor.getTasteVector();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async recordFeedback(arg0: string, arg1: string, arg2: number): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.recordFeedback(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
